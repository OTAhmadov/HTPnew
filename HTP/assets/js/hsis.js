...
var Hsis = {
    // token: '8c20b710b8594a9b95c95f9a64569d217d386117cc414024a2efb1f4d0f95a93',
    lang: 'az',
    appId: 1000017,
    currModule: '',
    operationList: [],
                ...
                if (data) {
                    $.each(data, function (i, v) {
                        html += '<div class="col-md-12 for-align doc-item" doc-type="' + doctype + '">' +
                            '<table class="table-block col-md-12">' +
                            '<tr>' +
                            '<td>' + Hsis.dictionary[Hsis.lang]['order_type'] + '</td>' +
                            '<td>' + Hsis.dictionary[Hsis.lang]['order_series'] + '</td>' +
                            '<td>' + Hsis.dictionary[Hsis.lang]['order_number'] + '</td>' +
                            '<td>' + Hsis.dictionary[Hsis.lang]['issue_date'] + '</td>' +
                            // '<td>' + Hsis.dictionary[Hsis.lang]['end_date'] + '</td>' + '<td></td>' +
                            '</tr>' +
                            '<tr>' +
        ...
        parseQuestionnaireView: function (result) {
            ...
            if (result.contacts.length > 0) {
                ...
                $.each(result.contacts, function (i, v) {
                    html += '<ul style="padding-left: 0; margin-top: 0; margin-bottom: 2px;">'+
                        '<li style="list-style: none"><span style="margin-right: 2%; float: left;">'+ v.type.value[Hsis.lang]+'</span></li>'+
                        '<li style="list-style: none"><span style="margin-right: 2%;">'+ v.contact+'</span></li>'+
                        '</ul>';
                });
            ...
            if (result.documents.length > 0) {
                ...
                $.each(result.documents, function (i, v) {
                    ...
                    if(v.type != undefined && v.type.id == '1000288'){
                        html += '<ul style="padding-left: 0; margin-top: 0; margin-bottom: 2px;">'+
                            '<li style="list-style: none"><span style="margin-right: 2%;">Şəxsiyyət vəsiqəsinin seriyası və nömrəsi: </span>'+ v.serial+' / ' + v.number +'</li>'+
            ...
            if (result.orderDocuments.length > 0) {
                ...
                $.each(result.orderDocuments, function (i, v) {
                    html += '<ul style="padding-left: 0; margin-top: 0; margin-bottom: 2px;">'+
                        ...
                        '<li class="order-document" style="list-style: none;"><span style="margin-right: 2%;">Əmr nömrəsi və tarixi:</span>'+v.serial+' / ' + v.number +' - '+ v.startDate+'</li>'+
            ...
            if (result.relations.length > 0) {
                ...
                $.each(result.relations, function (i, v) {
                    html += '<ul style="padding-left: 0; margin-top: 2px; margin-bottom: 2px;">'+
                        '<li style="list-style: none;"><span style="margin-right: 2%;">Qohumluq əlaqəsi:</span>'+v.type.value[Hsis.lang]+'</li>'+
                        '<li style="list-style: none;"><span style="margin-right: 2%;">Adı:</span>'+v.fullName+'</li>'+
                        '<li style="list-style: none;"><span style="margin-right: 2%;">Əlaqə:</span>'+v.contactNumber+'</li>'+
                        '</ul>'
                });
          ...
          /*  if (result.achievements.length > 0) {
            ...
            if (result.pelcAction.length > 0) {
                ...
                $.each(result.pelcAction, function (i, v) {
                    html += '<ul style="padding-left: 0; margin-top: 0; margin-bottom: 2px;">'+
                        '<li style="list-style: none;"><span style="margin-right: 2%;">Təhsil müəssisəsi:</span>'+v.org.value[Hsis.lang]+'</li>'+
                        '<li style="list-style: none;"><span style="margin-right: 2%;">Başlama hərəkəti: </span>'+v.actionType.value[Hsis.lang]+'</li>'+
                        '<li style="list-style: none;"><span style="margin-right: 2%;">Başlama tarixi: </span>'+v.actionDate+'</li>'+
                        '<li style="list-style: none;"><span style="margin-right: 2%;">Bitmə hərəkəti: </span>'+v.endActionType.value[Hsis.lang]+'</li>'+
                        '<li style="list-style: none;"><span style="margin-right: 2%;">Bitmə tarixi:</span>'+v.endActionDate+'</li>'+
                        '</ul>'
                });
            ...
            $('#main-div').load('partials/abroad_student_view.html', function () {
                Hsis.Proxy.getAbroadStudentDetails(localStorage.personId, function (data) {
                    if (data) {
                        ...
                        $('#main-div #spec_direction').html(data.spec.value[Hsis.lang]);
